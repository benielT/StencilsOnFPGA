...
float test_blacksholes_call_option(BlacksholesParameter calcParam, double * time_to_run=nullptr, bool verbose = false);
...
bool verify_grid(float* curent, float* next, GridParameter gridData);

void print_grid(float* grid, GridParameter gridData, const std::string gridName="");
